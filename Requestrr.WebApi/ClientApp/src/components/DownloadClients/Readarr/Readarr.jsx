...
import { testReadarrSettings as testSettings } from "../../../store/actions/ReadarrClientActions"
import { setReadarrConnectionSettings as setConnectionSettings } from "../../../store/actions/ReadarrClientActions"
import ValidatedTextbox from "../../Inputs/ValidatedTextbox"
import Textbox from "../../Inputs/Textbox"
import Dropdown from "../../Inputs/Dropdown"
import ReadarrCategoryList from "./ReadarrCategoryList"
...
function Readarr(props) {
    ...
    return (
        <>
            ...
            <div className="pl-lg-4">
                ...
                <Row>
                    <Col lg="6">
                        <Textbox
                            name="Base Url"
                            placeholder="Enter base url configured in Readarr, leave empty if none configured."
                            value={baseUrl}
            ...
            <ReadarrCategoryList isSubmitted={props.isSubmitted} isSaving={props.isSaving} apiVersion={apiVersion} canConnect={isHostnameValid && isPortValid && isApiKeyValid} />
            <div>
                <h6 className="heading-small text-muted mt-4">
                    Readarr Requests Permissions Settings
                </h6>
            </div>
            <div className="pl-lg-4">
                <Row>
                    <Col lg="6">
                        <FormGroup className="custom-control custom-control-alternative custom-checkbox mb-3">
                            ...
                            <label
                                ...
                                <span className="text-muted">Automatically monitor newly added books</span>
                            </label>
                        </FormGroup>
                        <FormGroup className="custom-control custom-control-alternative custom-checkbox mb-3">
                            <Input
                            ...
                            <label
                                ...
                                <span className="text-muted">Automatically search for books when request is made</span>
                            </label>
                        </FormGroup>
                    </Col>
                </Row>
